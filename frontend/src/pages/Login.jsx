...
function Login() {
  ...
  return (
    <div className="w-full flex justify-center items-center min-h-screen bg-[radial-gradient(circle_at_20%_30%,rgba(76,214,255,0.08)_0%,transparent_50%),radial-gradient(circle_at_80%_70%,rgba(157,80,187,0.08)_0%,transparent_50%)]">
      <div className=" rounded-3xl w-100 h-150 flex flex-col justify-center items-center gap-6 bg-linear-to-br from-white/20 via-white/5 to-white/0 bg-origin-border shadow-[0_8px_32px_0] shadow-black/37">
        <h1 className="text-5xl font-extrabold text-white mb-10">SplitEasy</h1>
